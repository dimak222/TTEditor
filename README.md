...
3. Редактировать, а затем обновлять файлы ТТ у всех пользователей (необходим общий доступ к файлам ТТ, к примеру, расположить их на сервере и указать в настройках "Использовать ТТ с сервера").
